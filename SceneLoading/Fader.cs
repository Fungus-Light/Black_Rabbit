...
namespace Black_Rabbit
{
    ...
    /// </summary>
    public class MMFader : MonoBehaviour, MMEventListener<FadeEvent>, MMEventListener<MMFadeInEvent>, MMEventListener<MMFadeOutEvent>
    {
        ...
        {
            this.MMEventStartListening<FadeEvent>();
        ...
        {
            this.MMEventStopListening<FadeEvent>();
